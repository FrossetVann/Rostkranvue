...
const sliders = ref([
  { id: 0, topic: 'Монтаж, пуско-наладка и ремонт оборудования', text: 'описание описание описание описание описание описание описание описание описание', img: '/temp_slide.jpg' },
  { id: 1, topic: 'Техническое обслуживание', text: 'описание описание описание описание описание описание описание описание описание', img: '/temp_slide.jpg' },
  { id: 2, topic: 'Установка и наладка приборов', text: 'описание описание описание описание описание описание описание описание описание', img: '/temp_slide.jpg' },
]);
